...
latex_documents = [
    (master_doc, "DyNN.tex", "DyNN Documentation",
     "Paul Michel", "manual"),
]
...
man_pages = [
    (master_doc, "dynn", "DyNN Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "DyNN", "DyNN Documentation",
     author, "DyNN", "One line description of project.",
     "Miscellaneous"),
]
...
intersphinx_mapping = {
    ...
    "dynet": ("https://dynet.readthedocs.io/en/latest/", None),
}
